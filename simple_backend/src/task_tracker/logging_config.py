...
def setup_logging() -> None:
    dictConfig({
        ...
        "loggers": {
            # твои модули
            "task_tracker": {"handlers": ["console", "file"], "level": LOG_LEVEL, "propagate": False},
            # httpx/uvicorn ниже подцепим отдельно
        },
        # базовый логгер (если где-то вызовут logging.info(...) без getLogger)
        "root": {"handlers": ["console", "file"], "level": LOG_LEVEL},
    })

    # привести uvicorn-логгеры к нашему формату/уровню
    ...
    # немного приглушим болтливые либы (по желанию)
